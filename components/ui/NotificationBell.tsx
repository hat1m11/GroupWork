...
export default function NotificationBell({ userId }: Props) {
  ...
  return (
    <div ref={ref} className="relative">
      <button
        onClick={() => setOpen((o) => !o)}
        className="relative p-1.5 text-gray-500 hover:text-indigo-600 transition-colors"
      ...
      {open && (
        <>
          ...
          <div className="absolute right-0 top-10 z-30 w-80 bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
            ...
            <div className="max-h-80 overflow-y-auto divide-y divide-gray-50">
              ...
              {notifications.map((n) => (
                ...
                >
                  <span className={`mt-1.5 flex-shrink-0 w-2 h-2 rounded-full ${!n.read ? "bg-indigo-500" : "bg-transparent"}`} />
